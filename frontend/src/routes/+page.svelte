...
<script>
    ...
    import graph from '$lib/assets/graph.svg'
    import cog from '$lib/assets/cog.svg'
</script>

<div class="flex flex-row justify-center h-20 w-auto">
    <button class="bg-navbut w-60 mr-5 sm:mr-10 rounded-b border-l border-r border-b-4 border-black"
    on:click={() => {}}>
    ...
    <button class="bg-navbut w-60 rounded-b border-l border-r border-b-4 border-black"
            on:click={() => {}}>
